...
$mail->Username = 'bananamachinada@gmail.com'; // Conta de email existente e ativa em seu domínio
...
$mail->AddAddress('contato@lucianofagundes.kinghost.net'); // Define qual conta de email receberá a mensagem
